    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-3xl mx-auto space-y-6 pointer-events-none">
         <div className="space-y-2">
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-foreground drop-shadow-sm font-sora">
            The Infinite Grid
          </h1>
        ...
        <div className="flex gap-4 pointer-events-auto">
          <button 
              ...
              className="px-8 py-3 bg-[#2563EB] text-white font-semibold rounded-xl hover:bg-blue-700 transition-all shadow-md active:scale-95 font-sora text-sm cursor-pointer"
          >
              Interact ({count})
          </button>
          <button 
              className="px-8 py-3 bg-slate-100 text-slate-800 border border-slate-200 font-semibold rounded-xl hover:bg-slate-200 transition-all active:scale-95 font-sora text-sm cursor-pointer"
          >
              Learn More
          </button>
        </div>
