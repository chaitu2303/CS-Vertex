...
export const QuoteView: React.FC = () => {
  ...
  return (
    <div className="py-24 px-6 lg:px-12 xl:px-16 max-w-[1440px] mx-auto z-10 w-full text-slate-800">
      ...
      >
        <div className="p-8 md:p-10 bg-white/40 backdrop-blur-xl border border-white/60 rounded-3xl relative overflow-hidden shadow-[0_20px_50px_rgba(15,23,42,0.05)]">
          <div className="absolute top-0 right-0 w-64 h-64 bg-blue-400/10 rounded-full blur-3xl pointer-events-none -mr-32 -mt-32" />
          
          <div className="flex items-center gap-3 mb-8 pb-6 border-b border-white/50 relative z-10">
